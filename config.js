const config = {
  ...
  serverIp: 'IP:PORT', // the server ip
  token: 'MTA5MzY4MTUyMTU2NDU5ODMyMw.Gdp-5v.tx-PYY9bBxXdMYlPbzszdTo_NSDrZCQVKi6WsQ', // your bot's token
  ...
  operators: [ '1234567890', '0987654321', ], // an array of user ids that can send commands to the server (not including start + stop)
